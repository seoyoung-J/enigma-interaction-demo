...
ENIGMA-51 데이터셋을 기반으로 산업 작업 장면에서의 인간-객체 상호작용을 분류하고 예측하는 데모입니다.  
최근 4개 프레임의 특징 벡터를 시퀀스 입력으로 사용하여 다음 항목을 예측합니다.
...
## Project Structure  
- `enigma_outputs` : 실험 결과로 생성된 CSV 파일과 시각화 이미지 등 산출물을 저장  
